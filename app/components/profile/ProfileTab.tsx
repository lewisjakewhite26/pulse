...
function GlassCard({ children, style = {} }: { children: React.ReactNode; style?: React.CSSProperties }) {
  return (
    <div style={{
      background: "rgba(255,255,255,0.6)", backdropFilter: "blur(12px)", borderRadius: 16,
      padding: "14px 16px", border: "1px solid rgba(255,255,255,0.2)", boxShadow: "0 4px 24px rgba(0,0,0,0.04)",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16, minWidth: 0 }}>
      <div>
        ...
        <div style={{ fontSize: 13, color: C.onSurfaceVariant, marginTop: 4 }}>What Pulse knows about you.</div>
      </div>

      <GlassCard>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          <div style={{ fontSize: 15, fontWeight: 700, color: C.primary }}>You</div>
        </div>
      ...
      <GlassCard>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
          <div style={{ fontSize: 15, fontWeight: 700, color: C.secondary }}>Your goal</div>
          <button type="button" onClick={() => setEditingGoal(!editingGoal)} style={{ background: "none", border: "none", cursor: "pointer", padding: 4 }}>
            <span className="material-symbols-outlined" style={{ fontSize: 18, color: C.onSurfaceVariant }}>edit</span>
          </button>
        </div>
        {editingGoal ? (
          <>
      ...
      <GlassCard>
        <div style={{ fontSize: 15, fontWeight: 700, marginBottom: 12 }}>What Pulse knows</div>
      ...
      <GlassCard>
        ...
        {t.calculated && t.calories ? (
          ...
          <p style={{ fontSize: 13, color: C.onSurfaceVariant, lineHeight: 1.6 }}>
            Pulse will suggest targets after a few days of logging. You can also set them manually by talking to your coach.
          </p>
        )}
      </GlassCard>
      ...
      <GlassCard>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
          <button type="button" onClick={() => exportAllData()} style={{ width: "100%", padding: "11px 16px", borderRadius: 999, background: C.primary, color: "#fff", border: "none", cursor: "pointer", fontSize: 13, fontWeight: 700, fontFamily: "inherit", boxSizing: "border-box" }}>
            Download today&apos;s backup
          </button>
          <label style={{ width: "100%", padding: "11px 16px", borderRadius: 999, background: "transparent", color: C.onSurfaceVariant, border: `1px solid ${C.outlineVariant}`, cursor: "pointer", fontSize: 13, fontWeight: 600, fontFamily: "inherit", textAlign: "center", boxSizing: "border-box", display: "block" }}>
            Restore from backup
